...
export function Toolbar() {
  ...
  return (
    <div className="flex items-center h-10 px-3 bg-panel border-b border-border shrink-0 gap-1">
      <span className="text-xs text-textMuted mr-2 uppercase tracking-wider">
        Insert
      </span>
      {TOOLS.map((tool) => (
        <button
      ...
      <div className="relative">
        ...
        {shapesOpen && (
          <div className="absolute top-full left-0 mt-1 w-56 bg-panel border border-border rounded-lg shadow-lg p-2 z-10">
            <div className="text-[11px] text-textMuted uppercase tracking-wider px-2 py-1">
              Basic Shapes
            </div>
