    ...
    <div className="p-4 flex flex-col gap-4">
      <div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <Select
            ...
            onChange={(v) => {
              (obj as any).objectFit = v;
              canvas.renderAll();
            }}
            options={["contain", "cover", "fill", "none"].map((v) => ({
              value: v,
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <NumberInput
            label="Scale X"
            value={Number((obj.scaleX ?? 1).toFixed(2))}
            onChange={(v) => {
              obj.set({ scaleX: v });
              canvas.renderAll();
            }}
          ...
          <NumberInput
            label="Scale Y"
            value={Number((obj.scaleY ?? 1).toFixed(2))}
            onChange={(v) => {
              obj.set({ scaleY: v });
              canvas.renderAll();
            }}
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            ...
            <select
              value={videoType}
              onChange={(e) => {
                (obj as any).videoType = e.target.value;
                canvas.renderAll();
              }}
          ...
          {videoType === "embed" ? (
            <div>
              ...
              <input
                value={src}
                onChange={(e) => {
                  (obj as any).videoSrc = e.target.value;
                  canvas.renderAll();
                }}
          ...
          <ColorPicker
            label="Border Color"
            value={(obj as any).stroke ?? "#8b5cf6"}
            onChange={(v) => {
              obj.set({ stroke: v });
              canvas.renderAll();
            }}
