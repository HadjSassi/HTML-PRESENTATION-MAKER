...
export function ShapeProperties({ obj, canvas }: Props) {
  ...
  const apply = (props: Record<string, unknown>, style?: Record<string, unknown>) => {
  ...
  return (
    <div className="p-4 flex flex-col gap-4">
      <h3 className="text-xs font-semibold text-textSecondary uppercase tracking-wider">Shape</h3>
      {supportsFill(obj) && (
        <ColorPicker
          label="Fill"
          value={fill}
